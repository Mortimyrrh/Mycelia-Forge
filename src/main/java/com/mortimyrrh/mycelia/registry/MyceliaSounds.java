...
public class MyceliaSounds
{
    ...
    //public static final RegistryObject<SoundEvent> PORTAL_SOUND_EVENT =  SOUND_EVENTS.register("portal_sound_event", () -> new SoundEvent(ResourceLocation.create("sounds/portal1.oog", '/')));
}
